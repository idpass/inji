...
"reviewing"?: "accepted" | "acceptedIntentShare" | "accepting" | "displayingIncomingVC" | "idle" | "invalidIdentity" | "navigatingToHistory" | "navigatingToHome" | "navigatingToReceivedCards" | "rejected" | "savingFailed" | "verifyingIdentity" | "verifyingVp" | { "accepting"?: "mergingIncomingVc" | "prependingReceivedVc" | "requestingExistingVc" | "requestingReceivedVcs" | "storingVc";
